...
public class MessageResource {
    ...
    @GetMapping("/messages/product/{productId}")
    @Timed
    public ResponseEntity<List<MessageDTO>> getMessageByProduct(@PathVariable Long productId) {
        List<MessageDTO> page = messageService.findOneByProductId(productId);
