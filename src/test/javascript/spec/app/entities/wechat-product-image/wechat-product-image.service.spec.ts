...
describe('Service Tests', () => {
    ...
    describe('WechatProductImage Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(WechatProductImageService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/wechat-product-images';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return WechatProductImage', () => {

                let entity: WechatProductImage;
                service.find(123).subscribe((_entity: WechatProductImage) => {
                    entity = _entity;
                });
