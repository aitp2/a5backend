...
describe('Service Tests', () => {
    ...
    describe('WechatWishList Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(WechatWishListService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/wechat-wish-lists';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return WechatWishList', () => {

                let entity: WechatWishList;
                service.find(123).subscribe((_entity: WechatWishList) => {
                    entity = _entity;
                });
