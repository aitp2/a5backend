...
describe('Service Tests', () => {
    ...
    describe('WechatOrderItem Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(WechatOrderItemService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/wechat-order-items';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return WechatOrderItem', () => {

                let entity: WechatOrderItem;
                service.find(123).subscribe((_entity: WechatOrderItem) => {
                    entity = _entity;
                });
